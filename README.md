...
- [Awesome Lists](https://github.com/sindresorhus/awesome): 🗂️Awesome lists about all kinds of interesting topics / `awesome.re` / [github topic - awesome](https://github.com/topics/awesome)
...
- AI learning portals: [Anthropic Academy](https://anthropic.skilljar.com/), [Google AI Training](https://grow.google/ai), [Meta AI Resources](https://ai.meta.com/resources/), [NVIDIA CUDA](https://developer.nvidia.com/cuda), [Microsoft Learn](https://learn.microsoft.com/en-us/training/), [OpenAI Academy](https://academy.openai.com/), [IBM SkillsBuild](https://skillsbuild.org/), [AWS Skill Builder](https://skillbuilder.aws/), [DeepLearning.AI](https://www.deeplearning.ai/), and [Hugging Face Learn](https://huggingface.co/learn)
...
- [AI Engineering](https://www.amazon.com/dp/1098166302) by Chip Huyen / [GitHub](https://github.com/chiphuyen/aie-book)
...
- [A Relational Model of Data for Large Shared Data Banks (1969)](https://dl.acm.org/doi/10.1145/362384.362685): E.F. Codd  
- [Dynamo: Amazon’s Highly Available Key-value Store (2007)](https://allthingsdistributed.com/files/amazon-dynamo-sosp2007.pdf): G. DeCandia et al.  
- [MapReduce: Simplified Data Processing on Large Clusters (2004)](https://static.googleusercontent.com/media/research.google.com/en//archive/mapreduce-osdi04.pdf): J. Dean, S. Ghemawat  
- [On the Criteria To Be Used in Decomposing Systems into Modules (1972)](https://win.tue.nl/~wstomv/edu/2ip30/references/criteria_for_modularization.pdf): D.L. Parnas  
- [Out of the Tar Pit (2006)](https://curtclifton.net/papers/MoseleyMarks06a.pdf): B. Moseley, P. Marks  
- [Time, Clocks, and the Ordering of Events in a Distributed System (1978)](https://microsoft.com/en-us/research/publication/time-clocks-ordering-events-distributed-system/): L. Lamport  
...
- [Borg](https://storage.googleapis.com/pub-tools-public-publication-data/pdf/43438.pdf): Large Scale Cluster Management at Google  
...
- [FoundationDB](https://www.foundationdb.org/files/fdb-paper.pdf): A look at how a distributed database works  
...
- [MyRocks](https://www.vldb.org/pvldb/vol13/p3217-matsunobu.pdf): LSM-Tree Database Storage Engine  
- [Raft Consensus Algorithm](https://raft.github.io/raft.pdf): Learn about the more understandable consensus algorithm  
...
- [WTF - Who to Follow Service at Twitter](https://web.stanford.edu/~ashishg/papers/wtf_overview.pdf): Twitter’s (now X) user recommendation system  
...
- [Free eBooks for ML, Data Science & AI](https://newsletter.theaiedge.io/p/30-free-machine-learning-e-books)
...
- [Approaching (Almost) Any ML Problem](https://github.com/abhishekkrthakur/approachingalmost) – Abhishek Thakur
...
- [Machine Learning for Humans](https://vas3k.com/blog/machine_learning/) – Vishal Maini, Samer Sabri
- [Machine Learning For Dummies](https://www.ibm.com/downloads/cas/GB8ZMQZ3) – Judith Hurwitz, Daniel Kirsch
- [Machine Learning Systems](https://www.mlsysbook.ai/): [Introduction to Machine Learning Systems](https://github.com/harvard-edge/cs249r_book) – Vijay Janapa Reddi 
- [Machine Learning Yearning](https://github.com/ajaymache/machine-learning-yearning) – Andrew Ng
...
- [@mathtalent Lecture Notes](https://skim.math.msstate.edu/LectureNotes/) – Math-focused CS notes
- [Algebra, Topology, Calculus & Optimization for CS/ML](https://www.cis.upenn.edu/~jean/gbooks/geomath.html) – Jean Gallier
- [Algorithms for Artificial Intelligence](https://web.stanford.edu/~mossr/pdf/alg4ai.pdf) – Moss
- [An Introduction to Statistical Learning](https://www.statlearning.com/) – James et al.
- [Calculus for Mathematicians, Computer Scientists, and Physicists](https://mathcs.holycross.edu/~ahwang/print/calc.pdf) – Andrew D. Hwang
- [Information Theory, Inference, and Learning Algorithms](http://www.inference.org.uk/mackay/itila/) – David J. C. MacKay
- [Math Foundations for Computer Science](https://web.stanford.edu/class/archive/cs/cs103/cs103.1184/notes/Mathematical%20Foundations%20of%20Computing.pdf) – Stanford CS103
- [Mathematical Methods for CV, Robotics, Graphics](http://graphics.stanford.edu/courses/cs205a-13-fall/assets/notes/cs205a_notes.pdf) – Stanford
- [Mathematics for Machine Learning](https://mml-book.github.io/) – Deisenroth, Faisal, Ong
- [Pattern Recognition and ML](https://www.microsoft.com/en-us/research/people/cmbishop/#!prml-book) – Christopher Bishop
- [The Elements of Statistical Learning](https://web.stanford.edu/~hastie/ElemStatLearn/) – Friedman, Tibshirani, Hastie

##### Probabilistic, Special Topics

- [A Brief Introduction to ML for Engineers](https://arxiv.org/abs/1709.02840) – Osvaldo Simeone
- [Applied Causal Inference](https://appliedcausalinference.github.io/aci_book/index.html) – Uday Kamath et al.
- [Automated Machine Learning](https://www.automl.org/book/) – Frank Hutter et al.
- [Boosting: Foundations and Algorithms](https://direct.mit.edu/books/oa-monograph/5342/BoostingFoundations-and-Algorithms) – Schapire & Freund
- [Computer Vision: Models, Learning, and Inference](https://udlbook.github.io/cvbook/) – Simon J.D. Prince
- [Deep Learning on Graphs](https://yaoma24.github.io/dlg_book/index.html) – Yao Ma & Jiliang Tang
- [Deep Learning Interviews](https://arxiv.org/abs/2201.00650) – Shlomo Kashani, Amir Ivry
- [Feature Engineering and Selection](https://bookdown.org/max/FES/) – Max Kuhn & Kjell Johnson
- [Interpretable Machine Learning](https://christophm.github.io/interpretable-ml-book/) – Christoph Molnar
- [ML Interpretability](https://www.oreilly.com/library/view/an-introduction-to/9781492033158/) – Patrick Hall & Navdeep Gill
- [Natural Language Processing with Python](https://www.nltk.org/book/) – Bird, Klein, Loper
- [Probabilistic ML: Advanced Topics](https://probml.github.io/pml-book/) – Kevin P. Murphy
- [Probabilistic ML: An Introduction](https://probml.github.io/pml-book/) – Kevin P. Murphy
...
- [Virgilio – Data Science Curriculum](https://github.com/virgili0/Virgilio)

##### Deep Learning & Math

- [Deep Learning Book (MIT)](https://github.com/janishar/mit-deep-learning-book-pdf)
- [Deep Learning Models by Rasbt](https://github.com/rasbt/deeplearning-models)
- [fastai Book (fastbook)](https://github.com/fastai/fastbook) | [Fast.ai courses](https://course.fast.ai/)
...
- [365 Data Science Flashcards](https://365datascience.com/flashcards/)
- [Applied ML – Papers & Blogs](https://github.com/eugeneyan/applied-ml)
- [Awesome Production Machine Learning](https://github.com/EthicalML/awesome-production-machine-learning)
- [Data Science Project Template (Cookiecutter)](https://github.com/drivendataorg/cookiecutter-data-science)
- [Machine Learning Tutorials](https://github.com/ujjwalkarn/Machine-Learning-Tutorials)
- [Machine Learning ZoomCamp](https://github.com/alexeygrigorev/mlbookcamp-code)
- [openpilot – Driver Assistance System](https://github.com/commaai/openpilot)

##### Interviews & Cheatsheets

- [CS 229 ML Cheatsheets](https://github.com/afshinea/stanford-cs-229-machine-learning)
- [Data Science Interview Q\&A](https://github.com/alexeygrigorev/data-science-interviews)
- [ML Interview Guide](https://github.com/Sroy20/machine-learning-interview-guide)

##### Machine Learning Essentials

- [Machine Learning Mastery by Jason Brownlee](https://machinelearningmastery.com/)
- [Papers With Code](https://paperswithcode.com/):🔬Research papers with code, datasets, and benchmarks
